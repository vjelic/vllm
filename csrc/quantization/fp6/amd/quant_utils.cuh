...
//nd
template<>
__inline__ __device__ uint8_t vec_conversion<uint8_t, __hip_bfloat16>(const __hip_bfloat16& a) {

  __hip_fp6_e2m3 fp6_val = __hip_fp6_e2m3(a);
...
//nd
template<>
__inline__ __device__ __hip_bfloat16 vec_conversion<__hip_bfloat16, uint8_t>(const uint8_t& a) {
...
//nd
template<>
__inline__ __device__ uint8_t scaled_vec_conversion<uint8_t, __hip_bfloat16>(const __hip_bfloat16& a, float scale) {
...
//nd
template<>
__inline__ __device__ __hip_bfloat16 scaled_vec_conversion<__hip_bfloat16, uint8_t>(const uint8_t& a, float scale) {

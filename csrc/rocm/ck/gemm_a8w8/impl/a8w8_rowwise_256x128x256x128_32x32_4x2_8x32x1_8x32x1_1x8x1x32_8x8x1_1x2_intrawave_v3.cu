...
a8w8_rowwise_256x128x256x128_32x32_4x2_8x32x1_8x32x1_1x8x1x32_8x8x1_1x2_intrawave_v3<F16>(
    torch::Tensor& XQ,
    torch::Tensor& WQ,
    torch::Tensor& x_scale,
    torch::Tensor& w_scale,
...
template torch::Tensor
a8w8_rowwise_256x128x256x128_32x32_4x2_8x32x1_8x32x1_1x8x1x32_8x8x1_1x2_intrawave_v3<B16>(
    torch::Tensor& XQ,
    torch::Tensor& WQ,
    torch::Tensor& x_scale,
    torch::Tensor& w_scale,

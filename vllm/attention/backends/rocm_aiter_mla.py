...
class AiterMLAMetadata(MLACommonMetadata):
    ...
    # This is for new AITER MLA API to work 
    # -- MTP support needs more changes.
...
class AiterMLAMetadataBuilder(MLACommonMetadataBuilder[AiterMLAMetadata]):
    ...
    def build(self, seq_lens: list[int], query_lens: list[int],
        ...
        if len(self.paged_kv_indptr) > 0:
            ...
            # This is hardcoded -- MTP is disabled
            #num_draft_tokens = 1
...
class AiterMLAState(MLACommonState[AiterMLAMetadata]):
    ...
    def graph_capture(self, max_batch_size: int):
        kv_indices, kv_indptr, last_page_lens, qo_indptr = get_aiter_mla_metadata(

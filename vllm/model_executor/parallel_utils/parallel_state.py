...
_TENSOR_MODEL_PARALLEL_GROUP_HALF = None
_TENSOR_MODEL_PARALLEL_GROUP_PAIR = None
...
def initialize_model_parallel(
    ...
    global _TENSOR_MODEL_PARALLEL_GROUP_HALF
    global _TENSOR_MODEL_PARALLEL_GROUP_PAIR
    ...
    for i in range(num_tensor_model_parallel_groups):
        ...
        if tensor_model_parallel_size>1:
            ranks_half1 = range(0,int(tensor_model_parallel_size/2))
...
def get_tensor_model_parallel_group_half_pair():
    """Get the tensor model parallel group the caller rank belongs to in half and pair tuple."""
    assert _TENSOR_MODEL_PARALLEL_GROUP_HALF is not None, \
        'intra_layer_model parallel group half is not initialized'
    return _TENSOR_MODEL_PARALLEL_GROUP_HALF,_TENSOR_MODEL_PARALLEL_GROUP_PAIR

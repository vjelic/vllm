...
from vllm.model_executor.layers.ep_moe.kernels import (
...
from vllm.model_executor.layers.quantization.fp8 import (
    Fp8Config, Fp8MoEMethod)
# from sglang.srt.layers.quantization.fp8_utils import normalize_e4m3fn_to_e4m3fnuz
from vllm.model_executor.layers.quantization.utils.fp8_utils import normalize_e4m3fn_to_e4m3fnuz
...
if current_platform.is_tpu():
    ...
    from vllm.model_executor.layers.fused_moe.moe_torch_iterative import fused_moe as fused_moe_pallas
else:

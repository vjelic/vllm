...
class PagedAttention(nn.Module):
    ...
    def __init__(self,
        ...
        #self.attn_op = xops.fmha.MemoryEfficientAttentionFlashAttentionOp[0]
    ...
    def set_attn_bias(self, input_metadata: InputMetadata) -> None:
        if os.environ.get('VLLM_USE_XFORMERS'):
    ...
    def multi_query_kv_attention(
        ...
        elif os.environ.get('VLLM_USE_XFORMERS'):
        ...
        elif os.environ.get("VLLM_USE_NAIVE"):
            output = self.ref_multi_query_kv_attention(
                input_metadata.cu_seqlens_tensor,
                query,
                key,
                value,
                dtype=torch.float16,

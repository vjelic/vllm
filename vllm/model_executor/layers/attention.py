...
class PagedAttention(nn.Module):
    ...
    def __init__(
        ...
        # FlashAttention could give better performance, especially for MQA/GQA.
        # As of Jan 2024, FlashAttention has some limits:
        #    * head size up to 256.
        #    * datatype fp16 and bf16.
        # Datatype could not be retrived at this, so we retive it in forward function.
        self.use_flash_attn = self.head_size <= 256
    ...
    def forward(
        ...
        if input_metadata.is_prompt:
            self.use_flash_attn = self.use_flash_attn and query.dtype != torch.float

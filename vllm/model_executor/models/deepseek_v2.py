...
class DeepseekV2MoE(nn.Module):
    ...
    def __init__(
        ...
        self.experts = FusedMoE(
            ...
            self.num_share_fusion_replicas,
            top_k=config.num_experts_per_tok + self.num_share_fusion_replicas,
        ...
        if config.n_shared_experts is not None and self.num_share_fusion_replicas == 0:
            intermediate_size = (config.moe_intermediate_size *
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        if self.n_shared_experts is not None and self.num_share_fusion_replicas == 0:
